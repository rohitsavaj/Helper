...
function wp_enqueue_scripts_fun() {
	...
	wp_enqueue_style('poppins', 'https://fonts.googleapis.com/css?family=Poppins:300,300i,400,400i,500,500i,600,600i,700,700i%7COpen+Sans:600', array(), null);
	wp_enqueue_style('one-css', get_template_directory_uri().'/css/one.css', array(), null);
	...
	wp_enqueue_script('one-js', get_template_directory_uri().'/js/one.js#asyncload', array(),null,true);
	wp_add_inline_script( 'one-js', 'var wpcf7 = {"apiSettings":{"root":"https:\/\/glasier.uk\/wp-json\/contact-form-7\/v1","namespace":"contact-form-7\/v1"}};','before' );
}
